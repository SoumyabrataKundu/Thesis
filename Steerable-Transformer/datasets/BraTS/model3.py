...
class Model(torch.nn.Module):
    def __init__(self) -> None:
        ...
        encoder_dim = channel(8)
        decoder_dim = channel(8)
        ...
        self.encoder_decoder = torch.nn.Sequential(
            snn.SE3TransformerEncoder(encoder_dim, 4, n_layers=4, add_pos_enc=True),
        )
        
        self.convolution_head1 = torch.nn.Sequential(
            snn.SE3Conv(channel(16), channel(4), 5, n_angle=n_angle, padding = 'same'),
            snn.SE3NormNonLinearity(channel(4)),
